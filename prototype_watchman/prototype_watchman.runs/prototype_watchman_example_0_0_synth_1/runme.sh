...
HD_PWD='/home/idlab-52/Desktop/GitVivado/WATCHMAN/prototype_watchman/prototype_watchman.runs/prototype_watchman_example_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prototype_watchman_example_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prototype_watchman_example_0_0.tcl
